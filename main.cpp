...
#include <rs-vino/object-detection.h> // This throws an InferenceEngine and OpenCV error
...
#include <rs-vino/openvino-helpers.h> // This throws an InferenceEngine and OpenCV error
