...
message(STATUS InferenceEngineConfig.cmake[start] ----------------------)
#get_filename_component(PACKAGE_PREFIX_DIR "${CMAKE_CURRENT_LIST_DIR}/../" ABSOLUTE)
#set(PACKAGE_PREFIX_DIR /opt/intel/deployment_tools/inference_engine)
...
#    set_and_check(_tbb_dir "${PACKAGE_PREFIX_DIR}/external/tbb/cmake")
    set_and_check(_tbb_dir "/opt/intel/deployment_tools/inference_engine/external/tbb")
    message(STATUS _tbb_dir: (${_tbb_dir}))
    _ie_find_dependency(TBB
            COMPONENTS tbb tbbmalloc
            CONFIG
            PATHS ${_tbb_dir}/cmake ${_tbb_dir}
            NO_CMAKE_FIND_ROOT_PATH
            NO_DEFAULT_PATH)
    message(STATUS deps[TBB]: (${TBB_LIBS}))
endif()

set_and_check(_ngraph_dir "/opt/intel/deployment_tools/ngraph")
_ie_find_dependency(ngraph
        CONFIG
        PATHS ${_ngraph_dir}/cmake
        NO_CMAKE_FIND_ROOT_PATH
        NO_DEFAULT_PATH)

if(NOT TARGET inference_engine)
    message(STATUS inference_engine: NOT TARGET)
    set(_ie_as_external_package ON)
    include(/opt/intel/deployment_tools/inference_engine/share/InferenceEngineTargets.cmake)
endif()
...
#if(_ie_as_external_package)
#    message(STATUS ** deprication_error *** _ie_as_external_package)
#    _ie_target_no_deprecation_error(${InferenceEngine_LIBRARIES})
#endif()
#unset(_ie_as_external_package)

set_and_check(InferenceEngine_INCLUDE_DIRS "/opt/intel/deployment_tools/inference_engine/include")
...
message(STATUS InferenceEngineConfig.cmake[finish] ----------------------)
